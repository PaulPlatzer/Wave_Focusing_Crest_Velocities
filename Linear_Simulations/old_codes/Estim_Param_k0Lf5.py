...
#---------#
# This piece of code is to be used alongside with "Linear_GWP_k0Lf5.py" that produces "eta1",
...
nstart1=0 #this starts the observation/estimation at t=-2|\tau|
nstart2=166 #this starts the observation/estimation at t=-|\tau|
...
## Store the data
np.savez('GWP_k0Lf5_phi%.5f' % phi0,tfoc1=tfoc1,tau_abs1=tau_abs1
